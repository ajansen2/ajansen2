...
*a small studio of products —*
*fashion, commerce, and the tools in between.*
...
**[FITR](https://github.com/FITR-MAE)** — a style engine for how people actually dress.
**SŌEN** — the AI stylist living inside it. powered by claude.
**a quiet shelf of shopify + etsy apps** — see the pinned, below.
...
![Etsy](https://img.shields.io/badge/Etsy-F16521?style=for-the-badge&logo=etsy&logoColor=white)
...
![Shopify CLI](https://img.shields.io/badge/Shopify_CLI-95BF47?style=for-the-badge&logo=shopify&logoColor=white)
...
graphics, games, and the coursework that taught me to finish things —
[3D-Maze-Game](https://github.com/ajansen2/3D-Maze-Game)  ·  [RayTrace](https://github.com/ajansen2/RayTrace)  ·  [Chess-Game](https://github.com/ajansen2/Chess-Game).
